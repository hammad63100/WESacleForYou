...
const ServiceDetails = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
          ...
          <div className="grid md:grid-cols-3 gap-8 justify-center max-w-5xl mx-auto">
            {stats.map((stat, idx) => (
              <div key={idx} className="flex flex-col items-center justify-center relative">
                <div className="w-32 h-32 sm:w-40 sm:h-40 lg:w-48 lg:h-48 rounded-full border-4 border-primary/20 flex flex-col items-center justify-center bg-background shadow-lg relative z-10">
                  <span className="text-2xl sm:text-3xl lg:text-4xl font-bold text-primary">{stat.value}</span>
      ...
      {/* Process Section */}
      <section className="py-12 sm:py-16 lg:py-20 bg-primary/10 relative">
      ...
      <section className="py-12 sm:py-16 lg:py-20 bg-background text-center">
        <div className="container mx-auto px-4">
      ...
      {/* CTA Footer Section */}
      <section className="py-12 sm:py-16 lg:py-24 bg-[#0a2e23] text-white relative overflow-hidden">
